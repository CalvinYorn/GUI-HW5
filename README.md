...
- Drag tiles back from board to rack
- Garbage bin with brown border to discard unwanted tiles
- Tile adjacency validation (tiles must be connected)
- Accurate scoring with bonus multipliers
- Recall Tile button to undo placements
- Refresh Tiles button to swap all tiles
- Letter counter showing remaining tiles in bag
...
3. Drag tiles back to rack or to trash bin to remove them
4. Click Validate Word to score your word
5. New tiles are automatically dealt after validation
...
- Recall Tile - Returns last placed tile to your rack
